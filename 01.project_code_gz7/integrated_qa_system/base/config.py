...
class Config:
    ...
    def __init__(self, config_file=None):
        ...
        self.DATA_DIR = os.path.join(self.PROJECT_ROOT, 'rag_qa')
        ...
        # MySQL 端口
        self.MYSQL_PORT = int(os.getenv('MYSQL_PORT', self.config.get('mysql', 'port', fallback=3307)))
        # MySQL 用户名
        ...
        # Milvus 配置
        # Milvus 主机地址
        self.MILVUS_HOST = os.getenv('MILVUS_HOST', self.config.get('milvus', 'host', fallback='192.168.66.47'))
        # Milvus 端口
